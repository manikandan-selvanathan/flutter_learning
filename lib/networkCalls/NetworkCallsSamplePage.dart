  ...
  Widget build(BuildContext context) {
    return Center(
      child:Column(
        ...
        children: <Widget>
        [
          MaterialButton(height: 50,minWidth: 200 , color: Colors.red,clipBehavior: Clip.antiAlias,textColor: Colors.white, child: Text("Get API Call"),onPressed: () async{
            try{
                  pr.show();
          ...
          SizedBox(height: 50), 
           MaterialButton(height: 50,minWidth: 200 , color: Colors.green,clipBehavior: Clip.antiAlias,textColor: Colors.white, child: Text("Get JSON Call"),onPressed: () async{
            try{
                  pr.show();
                  var helper=new FlutterTrainingHelper();
